...
return [
    ...
    'Plugin upload' => 'Plugin hochladen',
    'After SMTP is set correctly, it can be used to send e-mails, for example, to retrieve the password via e-mail.' => 'Nachdem SMTP richtig eingestellt wurde, kann es zum Senden von E-Mails verwendet werden, um beispielsweise das Kennwort per E-Mail abzurufen.',
    'Comment filtering' => 'Kommentarfilterung',
    'You can set keywords that are not allowed in comments, use commas between multiple keywords or one line per keyword.' => 'Sie können Schlüsselwörter festlegen, die in Kommentaren nicht zulässig sind, Kommas zwischen mehreren Schlüsselwörtern oder eine Zeile pro Schlüsselwort verwenden.',
    'Friendship link address is invalid' => 'Die Linkadresse ist ungültig',
];