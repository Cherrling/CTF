...
return [
    ...
    'Upload failed' => '上傳失敗',
    'Plugin upload' => '插件上傳',
    'After SMTP is set correctly, it can be used to send e-mails, for example, to retrieve the password via e-mail.' => '正確設置SMTP後，可用於發送電子郵件，例如通過郵件找回密碼。',
    'Comment filtering' => '評論過濾',
    'You can set keywords that are not allowed in comments, use commas between multiple keywords or one line per keyword.' => '您可以設置評論中不允許出現的關鍵詞，多個關鍵詞之間用逗號或者每個關鍵詞一行。',
    'Friendship link address is invalid' => '友情鏈接地址無效 ',
];