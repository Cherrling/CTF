...
return [
    ...
    'Plugin upload' => 'プラグインのアップロード',
    'After SMTP is set correctly, it can be used to send e-mails, for example, to retrieve the password via e-mail.' => 'SMTPが正しく設定されると、SMTPを使用して電子メールを送信したり、電子メールでパスワードを取得したりできます。',
    'Comment filtering' => 'コメントフィルタリング',
    'You can set keywords that are not allowed in comments, use commas between multiple keywords or one line per keyword.' => 'コメントで許可されていないキーワードを設定したり、複数のキーワードの間にコンマを使用したり、キーワードごとに1行を使用したりできます。',
    'Friendship link address is invalid' => 'リンクアドレスが無効です',
];